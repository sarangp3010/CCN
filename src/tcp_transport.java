...
public class tcp_transport {
     ...
     * @return
     * 
     *         This method is simply reads the data of the outputstream of the given
     *         socket and return the readed string.
     */
     ...
     * @param path
     * 
     *               This method of tcp_transport will collect file and it trandfer
     *               to the outputstream of the socket.
     */
    public static void send_file(Socket socket, String path) {
        try {
            ...
            // So that, for this, I took refrence from the
     ...
     * @param path
     * 
     *               This method receive the file data and write it to the given
     *               path.
     */
    public static void receive_file(Socket socket, String path) {
        try {
            // Create an Inpurt and fileoutputstreams to get data from the socket and write
            // data to file respectively.
     ...
     * @param directory
     * 
     *                  This is the void function which simply takes a arrayList and
     *                  path/directory and fill that list with the available files
     *                  in that directory.
     */
    public static void get_directory_files(ArrayList<String> al, String directory) {
        // create file object to collect all the files of the directory.
        File dir = new File(System.getProperty("user.dir") + "/" + directory);

        // This Returns an array of abstract pathnames denoting the files in the
